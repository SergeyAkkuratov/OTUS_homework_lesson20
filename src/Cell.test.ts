...
describe("Cell class tests", () => {
    ...
    it("Check constructor", () => {
        ...
        expect(cell.cellElement).toStrictEqual(getCellElementWithType(0, 0, "dead"));
    });
    ...
    it("Check onClick function", () => {
        ...
        expect(cell.cellElement).toStrictEqual(getCellElementWithType(0, 0, "alive"));
    ...
    it.each([
        [CellType.alive],
        [CellType.dead],
    ])("Check setType function", (type: CellType) => {
        cell.setType(type);
        expect(cell.type).toBe(type);
        expect(cell.cellElement).toStrictEqual(getCellElementWithType(0, 0, type));
    })
